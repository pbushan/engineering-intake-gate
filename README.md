...
**Current release:** `2026.9.0` (Controlled Dry Run MVP). It shows exactly what feedback and intake-state changes would be proposed, but it cannot enable Production or modify Azure DevOps.
...
The current release is `2026.9.0`; its corresponding Git tag is `v2026.9.0` when the owner chooses to create it.
...
- [2026.9.0 release notes](docs/RELEASE_NOTES_2026.9.0.md)
