...
export const runItemDetail: RunItemDetail = {
  ...
  analysisContext: { snapshotId: 'context-101', schemaVersion: 'analysis-context-v1', normalizedEvidenceSchemaVersion: 'normalized-evidence-v1', evaluatedRevision: '7', sourceFields: ['System.Title', 'System.Description'], humanCommentsIncluded: 2, humanCommentsAvailable: 2, generatedCommentsExcluded: 1, attachmentCount: 1, truncationOccurred: false, redactionOccurred: true, redactionCount: 1, processingWarnings: [], expiresAtUtc: '2026-10-12T14:00:00Z' },
...
export const systemHealth: SystemHealth = {
  ...
  database: { status: 'healthy', reachable: true, currentSchemaVersion: 16, migrationCurrent: true },
