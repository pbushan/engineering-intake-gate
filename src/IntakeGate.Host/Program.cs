...
builder.Services.AddSingleton<IPdfPageRenderer, PopplerPdfPageRenderer>();
...
builder.Services.AddSingleton<IAttachmentProcessor, SpreadsheetAttachmentProcessor>();
builder.Services.AddSingleton<IAttachmentProcessor, DocxAttachmentProcessor>();
builder.Services.AddSingleton<IMediaTool, FfmpegMediaTool>();
builder.Services.AddSingleton<IAttachmentEvidenceAiProvider, UnavailableAttachmentEvidenceAiProvider>();
builder.Services.AddSingleton<IAttachmentProcessor, MediaAttachmentProcessor>();
